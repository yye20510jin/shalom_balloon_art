...
import static com.shalom.shalom_balloon_art.global.error.ErrorCode.CREDENTIALS_INVALID;
...
public class UserEncryptService {
    ...
    public boolean pwDecrypt(String id, String inputPassword){
        User u = userRepository.findByUserId(id).orElseThrow(()->new BusinessException(CREDENTIALS_INVALID,""));
